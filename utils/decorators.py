...
from config.settings import MAX_SERVER_QUOTA, MAX_STORAGE_QUOTA 
...
def check_user_quota(func):
    ...
    def wrapped(request, *args, **kwargs):
        ...
        if user_quota.quota_cloud_size >= MAX_STORAGE_QUOTA:
            return HttpResponse("Превышена квота в облаке (10 МБ). Удалите лишние файлы", status=400)
